...
def test_material_maps():
    ...
    conv = default_2d(nx=8, ny=8, heat_mode="convection")
...
def test_darcy_2d_adjoint_matches_fd():
    params = default_2d(nx=10, ny=10, flow_model="darcy", flow_iters=250, heat_iters=250, filter_iters=80)
...
def test_stokes_2d_residual_small_on_solve():
    ...
    params = default_2d(nx=12, ny=12, flow_model="stokes", flow_iters=80, uzawa_iters=300)
